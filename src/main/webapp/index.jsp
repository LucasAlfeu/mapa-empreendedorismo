    ...
    <section id="corpo">
		...
		<div class="menu">
			...
			<ul id="lista-menu">
	    		...
	    		<li class="item-menu"><i class="fas fa-user-check"></i><a class="link-menu" href="./entrar.jsp"> Entrar</a>
	    		<li class="item-menu"><i class="fas fa-file-contract"></i><a class="link-menu" href="./cadastrar.jsp"> Cadastrar</a>
	    	</ul>
		</div>
		<section class="aba-filtro">
			...
			<form class="form-filtro">
				...
				<input type="submit" id="fechar-filtro" value="Filtrar">
			</form>
		</section>
    	<div id="map"></div>
    </section>
